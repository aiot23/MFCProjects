...
CString g_strFileImage = _T("c:\\Projects\\save.bmp");
...
void CmfcCImageDlg::moveRect()
{
	...
	UpdateDisplay();
	/*CString strFile;
	strFile.Format(_T("c:\\Projects\\image%d.jpg"), nSttX);
...
void CmfcCImageDlg::drawCircle(unsigned char* fm, int x, int y, int nRadius, int nGray)  //원그리기
{
